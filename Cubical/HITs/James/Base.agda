...
amap2 (αJ (surf i i₁) εJ) = surf i i₁
amap2 (αJ (surf i i₁) (αJ base x₁)) = amap2 (αJ (surf i i₁) x₁)
amap2 (αJ (surf i j) (αJ (surf k l) εJ)) = {!hlevS2 base base refl refl surf surf refl refl i j k l!}
amap2 (αJ (surf i j) (αJ (surf k l) (αJ x x₁))) = {!!}
amap2 (αJ (surf i j) (αJ (surf k l) (δJ x i₁))) = {!!}
  where
