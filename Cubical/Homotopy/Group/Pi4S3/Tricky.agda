...
open import Cubical.Algebra.Group renaming (Unit to UnitGr)
...
abstract
  ...
  S³→S²→Pushout→Unit' :
    exact (π'Gr 2 TotalPushoutPath×∙) (π'Gr 2 (S₊∙ 2)) (π'Gr 2 thePushout∙) UnitGr
          (π'∘∙Hom 2 ((λ x → snd (fst x)) , refl)) -- π₃S³→π₃S²'
          (π'∘∙Hom 2 inr∙)
          (→UnitHom (π'Gr 2 thePushout∙))
  S³→S²→Pushout→Unit' = {!extendExactSurj (π'Gr 2 P) ? (π'Gr 2 (S₊∙ 2)) (π'Gr 2 thePushout∙) UnitGr ? _ _ _ ? P→S²→Pushout→Unit
!}
   {-
    extendExactSurj {!!} {!!} (π'Gr 2 (S₊∙ 2)) (π'Gr 2 thePushout∙)
      UnitGr {!!} _ _ _ {!!} P→S²→Pushout→Unit
-}
